#!/usr/bin/python3
"""
Module unit Test for BaseModel Class
"""
import unittest
...
class TestUserFsInstances(unittest.TestCase):
    ...
    @unittest.skipIf(storage_type == 'db', 'skip if environ is db')
    def test_obj_saved_to_file(self):
        """Method checks correct FileStorage instance"""
        os.remove(F)
        self.user.save()
        u_id = self.user.id
        actual = 0
    ...
    @unittest.skipIf(storage_type == 'db', 'skip if environ is db')
    def test_reload(self):
        """Method checks correct usage of reload method"""
        os.remove(F)
        self.bm_obj.save()
        u_id = self.bm_obj.id
        actual = 0
...
class TestStorageGet(unittest.TestCase):
    """Method testing get in DBStorage"""

    @classmethod
    def setUpClass(cls):
        """Method setup tests for class"""
        print('\n\n.................................')
...
class TestStorageCount(unittest.TestCase):
    """Method tests count() method in DBStorage"""
