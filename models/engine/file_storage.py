...
class FileStorage:
    """Class dealing storage of all class instances"""
    CNC = {
    ...
    def count(self, cls=None):
        """Method counts instanes"""

        return len(self.all(cls))

    def save(self):
        """Method serializes __objects"""
